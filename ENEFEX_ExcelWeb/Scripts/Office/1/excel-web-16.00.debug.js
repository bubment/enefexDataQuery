	...
	this[OSF.DDA.DispIdHost.Methods.InvokeMethod]=function OSF_DDA_DispIdHost_Facade$InvokeMethod(method, suppliedArguments, caller, privateState) {
		...
		try {
			...
			if (window.Excel && window.Excel._RedirectV1APIs && (richApiInExcelMethodSubstitution=window.Excel._V1APIMap[methodName])) {
				...
				var result=richApiInExcelMethodSubstitution.call(context, callArgs);
				context.sync()
					.then(function () {
...
(function (OfficeExtension) {
	...
	var ClientRequestContext=(function () {
		...
		ClientRequestContext._run=function (contextInitializer, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure) {
			if (numCleanupAttempts===void 0) { numCleanupAttempts=3; }
			if (retryDelay===void 0) { retryDelay=5000; }
			return ClientRequestContext._runCommon("run", null, contextInitializer, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure);
		};
		ClientRequestContext._runBatch=function (functionName, receivedRunArgs, contextInitializer, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure) {
			if (numCleanupAttempts===void 0) { numCleanupAttempts=3; }
			if (retryDelay===void 0) { retryDelay=5000; }
			...
			if (receivedRunArgs.length==argOffset+1) {
				contextRetriever=contextInitializer;
				...
				if (receivedRunArgs[argOffset+0] instanceof OfficeExtension.ClientObject) {
					contextRetriever=function () { return receivedRunArgs[argOffset+0].context; };
				}
					...
					contextRetriever=function () { return array[0].context; };
				}
				else {
					return ClientRequestContext.createErrorPromise(functionName);
				}
			...
			return ClientRequestContext._runCommon(functionName, requestInfo, contextRetriever, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure);
		};
		...
		ClientRequestContext._runCommon=function (functionName, requestInfo, contextRetriever, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure) {
			...
			return starterPromise.then(function () {
				context=contextRetriever(requestInfo);
				if (requestInfo && !OfficeExtension.Utility.isNullOrEmptyString(requestInfo.url) && requestInfo.url !==context.m_url) {
					return ClientRequestContext.createErrorPromise(functionName, OfficeExtension.ErrorCodes.invalidRequestContext);
				}
				if (context._autoCleanup) {
					return new OfficeExtension.Promise(function (resolve, reject) {
						context._onRunFinishedNotifiers.push(function () {
							context._autoCleanup=true;
							resolve();
						});
					});
				}
				...
				return context.sync(batchResult);
				...
				var itemsToRemove=context.trackedObjects._retrieveAndClearAutoCleanupList();
				context._autoCleanup=false;
				...
				function attemptCleanup() {
					cleanupCounter++;
					for (var key in itemsToRemove) {
						context.trackedObjects.remove(itemsToRemove[key]);
					}
				...
				if (context._onRunFinishedNotifiers && context._onRunFinishedNotifiers.length > 0) {
					var func=context._onRunFinishedNotifiers.shift();
					func();
				}
				if (succeeded) {
...
(function (Excel) {
	...
	Excel._V1APIMap={
		"GetDataAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingGetData(callArgs); },
			postprocess: getDataCommonPostprocess
		},
		"GetSelectedDataAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.getSelectedData(callArgs); },
			postprocess: getDataCommonPostprocess
		},
		"GoToByIdAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.gotoById(callArgs); }
		},
		"AddColumnsAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingAddColumns(callArgs); }
		},
		"AddFromSelectionAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingAddFromSelection(callArgs); },
			postprocess: postprocessBindingDescriptor
		},
		"AddFromNamedItemAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingAddFromNamedItem(callArgs); },
			postprocess: postprocessBindingDescriptor
		},
		"AddFromPromptAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingAddFromPrompt(callArgs); },
			postprocess: postprocessBindingDescriptor
		},
		"AddRowsAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingAddRows(callArgs); }
		},
		"GetByIdAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingGetById(callArgs); },
			postprocess: postprocessBindingDescriptor
		},
		"ReleaseByIdAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingReleaseById(callArgs); }
		},
		"GetAllAsync": {
			call: function (context) { return context.workbook._V1Api.bindingGetAll(); },
		...
		"DeleteAllDataValuesAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingDeleteAllDataValues(callArgs); }
		},
		"SetSelectedDataAsync": {
			...
			call: function (context, callArgs) { return context.workbook._V1Api.setSelectedData(callArgs); }
		},
		"SetDataAsync": {
			preprocess: function (callArgs) {
				var preimage=callArgs["cellFormat"];
			...
			call: function (context, callArgs) { return context.workbook._V1Api.bindingSetData(callArgs); }
		},
		"SetFormatsAsync": {
			preprocess: function (callArgs) {
				var preimage=callArgs["cellFormat"];
			...
			call: function (context, callArgs) { return context.workbook._V1Api.bindingSetFormats(callArgs); }
		},
		"SetTableOptionsAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingSetTableOptions(callArgs); }
		},
		"ClearFormatsAsync": {
			call: function (context, callArgs) { return context.workbook._V1Api.bindingClearFormats(callArgs); }
		},
	};
