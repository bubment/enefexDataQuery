...
(function (OfficeExtension) {
	...
	var ClientRequestContext=(function () {
		...
		ClientRequestContext._run=function (contextInitializer, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure) {
			...
			return ClientRequestContext._runCommon("run", contextInitializer, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure);
		};
		ClientRequestContext._runBatch=function (functionName, receivedRunArgs, contextInitializer, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure) {
			...
			if (receivedRunArgs.length==1) {
				...
				if (receivedRunArgs[0] instanceof OfficeExtension.ClientObject) {
					contextRetriever=function () { return receivedRunArgs[0].context; };
				}
					...
					contextRetriever=function () { return array[0]; };
				}
				else {
					return ClientRequestContext.createErrorPromise(functionName);
				}
			...
			return ClientRequestContext._runCommon(functionName, contextRetriever, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure);
		};
		...
		ClientRequestContext._runCommon=function (functionName, contextRetriever, batch, numCleanupAttempts, retryDelay, onCleanupSuccess, onCleanupFailure) {
